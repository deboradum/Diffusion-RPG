...
class DIFF_GRMGRAPHTokenizer(AbstractTokenizer):
    """
    DIFF_GRMGRAPH Tokenizer for Diffusion-based Generative Recommendation Model
    ...
    def __init__(self, config: dict, dataset: AbstractDataset):
        ...
        super(DIFF_GRMGRAPHTokenizer, self).__init__(config, dataset)
        ...
        from genrec.models.DIFF_GRMGRAPH.collate import collate_fn_train, collate_fn_val, collate_fn_test
        self.collate_fn = {
    ...
    def _encode_sent_emb(self, dataset: AbstractDataset, output_path: str):
        ...
        assert self.config['metadata'] == 'sentence', \
            'DIFF_GRMGRAPHTokenizer only supports sentence metadata.'
    ...
    def tokenize_function(self, example: dict, split: str) -> dict:
        ...
        if split == 'train':
            ...
            # print("train")
            # print("history_sid:", history_sid, type(history_sid))
            # print("history_mask:", history_mask, type(history_mask))
            # print("decoder_inputs:", decoder_input, type(decoder_input))
            # print("decoder_labels:", decoder_labels, type(decoder_labels))
            return {
